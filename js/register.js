...
function validateRegisterForm() {
    ...
    if (name === '' || phone === '' || documentNumber === '' || email === '' || username === '' || password === '') {
        ...
        Swal.fire({
            ...
            window.location.href = "../dashboard/index.html"; // Puedes cambiar la URL de redirección según tus necesidades
        });
